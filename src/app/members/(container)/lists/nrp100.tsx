...
import { MapPinHouse, Bike, Phone, Instagram, Linkedin, Mail, HeartPlus } from "lucide-react";
      ...
      <Dialog.Portal>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <Dialog.Content className="w-full max-w-lg max-h-[95vh] bg-[#f9f7e4]/92 shadow-[0_0_100px_#efede4] rounded-2xl overflow-y-auto focus:outline-none p-10">
            ...
            <h2 className="text-3xl font-bold text-center font-nexa text-[#122D4F] mb-1">
              {data.name}
            </h2>
