...
function SaturnPlanet() {
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (event: MouseEvent) => {
      ...
      const rect = saturnRef.current
        ? saturnRef.current.getBoundingClientRect()
      ...
      >
        <div
          ...
          style={{
            ...
            background:
              "linear-gradient(90deg, transparent 0%, rgba(220, 210, 190, 0.7) 50%, transparent 100%)",
            borderRadius: "50%",
          }}
        ></div>
        <div
          ...
          style={{
            ...
            background:
              "linear-gradient(90deg, transparent 0%, rgba(240, 230, 210, 0.8) 50%, transparent 100%)",
            borderRadius: "50%",
          }}
        ></div>
        <div
          ...
          style={{
            ...
            background:
              "linear-gradient(90deg, transparent 0%, rgba(200, 190, 170, 0.3) 50%, transparent 100%)",
            borderRadius: "50%",
          }}
        ></div>
      </div>
    ...
    >
      <div className="absolute inset-0">
        ...
        <div
          ...
          style={{
            filter: "blur(30px)",
            transform: `translate(${x * parallaxIntensity * 1.5}px, ${
              y * parallaxIntensity * 1.5
            }px)`,
            willChange: "transform",
          }}
        ></div>
      ...
      {[...Array(3)].map((_, i) => (
        <div
          ...
          style={{
            ...
            transform: `translate(${x * parallaxIntensity * 0.3}px, ${
              y * parallaxIntensity * 0.3
            }px)`,
            animation: `comet-streak ${3 + Math.random() * 3}s linear ${
              Math.random() * 10
            }s infinite`,
            willChange: "transform",
          }}
      ...
      {stars.map((star) => (
        <div
          ...
          style={{
            ...
            willChange: "transform, opacity",
            transform: `translate(${x * parallaxIntensity * star.parallaxFactor}px, ${
              y * parallaxIntensity * star.parallaxFactor
            }px) translateZ(0)`,
          }}
        >
          {star.isSpecial ? "✨" : "*"}
  ...
  return (
    <>
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(135deg, rgba(162, 202, 228, 0.1) 0%, transparent 50%, rgba(123, 167, 209, 0.1) 100%)",
          borderImage:
            "linear-gradient(135deg, rgba(162, 202, 228, 0.4), rgba(123, 167, 209, 0.2), rgba(162, 202, 228, 0.4)) 1",
        }}
      >
        <Noise />
        ...
        <div className="aspect-[3/4] relative z-20 group">
          <div
            ...
            style={{
              ...
              boxShadow:
                "0 0 20px rgba(162, 202, 228, 0.3), inset 0 0 20px rgba(162, 202, 228, 0.1)",
            }}
          >
            <Image
      ...
      <MemberDialog
        ...
        showStarlightBurst={showStarlightBurst}
      />
      ...
      <style jsx global>{`
        @keyframes borderGlow {
          0%,
          100% {
            box-shadow: 0 0 20px rgba(162, 202, 228, 0.3);
          }
          50% {
            box-shadow: 0 0 30px rgba(162, 202, 228, 0.5), 0 0 60px rgba(162, 202, 228, 0.3);
          }
        }

        @keyframes comet-streak {
          0% {
            transform: translate(-100%, -100%) rotate(45deg) scaleX(0);
            opacity: 0;
          }
          10% {
            opacity: 1;
          ...
          100% {
            transform: translate(200%, 200%) rotate(45deg) scaleX(1);
            opacity: 0;
          }
        }
        ...
        @keyframes text-shadow-pulse {
          0%,
          100% {
            text-shadow: 0 0 15px rgba(162, 202, 228, 0.6), 0 0 30px rgba(162, 202, 228, 0.4);
          }
          50% {
            text-shadow: 0 0 20px rgba(162, 202, 228, 0.8), 0 0 40px rgba(162, 202, 228, 0.6);
          }
        }
      ...
      <Dialog.Portal>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <Dialog.Content
            ...
            style={{
              backgroundImage:
                "linear-gradient(135deg, rgba(162, 202, 228, 0.05) 0%, transparent 50%, rgba(123, 167, 209, 0.05) 100%)",
              borderImage:
                "linear-gradient(135deg, rgba(162, 202, 228, 0.4), rgba(123, 167, 209, 0.3), rgba(162, 202, 228, 0.4)) 1",
            }}
          >
            ...
            <div className="relative z-10">
              <div
                ...
                style={{
                  filter: "brightness(1.1)",
                  boxShadow:
                    "0 0 25px rgba(162, 202, 228, 0.4), inset 0 0 25px rgba(162, 202, 228, 0.1)",
                }}
              >
                <Image
                  src={`/images/members/${data.image}`}
              ...
              <div className="text-center space-y-2 mb-8">
                <h2
                  ...
                  style={{
                    animation: "text-shadow-pulse 2s ease-in-out infinite",
                    textShadow:
                      "0 0 20px rgba(162, 202, 228, 0.7), 0 0 40px rgba(162, 202, 228, 0.5)",
                  }}
                >
                  <a
                    href={data.instagram}
              ...
              <div className="space-y-4 text-[#DCE7F7] text-lg">
                ...
                >
                  <strong className="text-[#A2CAE4] drop-shadow-md font-bold">Asal:</strong>
                ...
                >
                  <strong className="text-[#A2CAE4] drop-shadow-md font-bold">Hobi:</strong>
                  <a
                ...
                >
                  <strong className="text-[#A2CAE4] drop-shadow-md font-bold">Funfact:</strong>
                  <span className="text-[#A2CAE4]/80 drop-shadow-sm group-hover:text-[#B8D4E8] transition-colors font-semibold">
                    {data.funfact.label}
                  </span>
                </div>
                ...
                >
                  ...
                  >
                    <div
                      ...
                      style={{
                        boxShadow:
                          "0 0 20px rgba(0, 0, 0, 0.5), inset 0 0 20px rgba(162, 202, 228, 0.1)",
                      }}
                    >
