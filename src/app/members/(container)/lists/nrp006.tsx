...
const data = {
  name: "Nabilah Anindya Paramesti",
  nrp: "5027241006",
  image: "006.jpg",
  funfact: "Suka liat bintang n citylight cihuy",
  hobby: "Nonton film, nonton series juga tapi ga sampe selesai :D",
  origin: "Surabaya",
};

export default function NRP006() {
