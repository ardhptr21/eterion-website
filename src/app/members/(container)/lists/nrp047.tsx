      ...
      >
        ...
        >
          ...
          <div className="relative z-10 mt-5 text-center">
            <h4 className={`text-xl font-bold text-white tracking-wider ${cinzel.className}`}>
              {data.name}
            </h4>
            <h6 className={`text-lg text-slate-400 ${cormorant.className}`}>{data.nrp}</h6>
          </div>
        </div>
      </div>
          ...
          <div className="relative rounded-xl animated-border overflow-hidden shadow-[0_0_60px_5px_rgba(102,231,182,0.7)]">
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className={`text-lg text-slate-300 ${cormorant.className}`}>{data.nrp}</p>
              </div>

              <div className="my-8 h-[2px] w-full bg-gradient-to-r from-transparent via-emerald-300/50 to-transparent" />

              <div className={`space-y-4 text-white/90 text-lg ${cormorant.className}`}>
                <p>
                  <strong className="font-semibold text-slate-400">Asal:</strong> {data.origin}
                </p>
                <p>
                  <strong className="font-semibold text-slate-400">Hobi:</strong> {data.hobby}
                </p>
                <p>
                  <strong className="font-semibold text-slate-400">Funfact:</strong> {data.funfact}
                </p>
              </div>
            </Dialog.Content>
          </div>
