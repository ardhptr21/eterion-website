...
export default function MemberCard({ name, ig, image }: Props) {
  return (
    <div className="min-w-sm max-w-sm shrink-0 p-10 rounded-xl border-2 border-accent relative bg-[#140c2c]/80 backdrop-blur-lg">
      <Noise />
      ...
      <div className="mt-5 z-10">
        <h4 className="text-3xl font-nexa font-bold">{name}</h4>
