...
export default function ColorPalette() {
  ...
  const colors = [
    ...
    { 
      ...
      color: "#5b8eb9", 
      textColor: "text-white",
      philosophy: "Melambangkan  keterbukaan dan fleksibel, memberi kesan adaptabilitas dan komunikasi yang terbuka."
    },
    { 
      name: "Mint Blue", 
      color: "#b6eadb", 
      textColor: "text-gray-800",
      philosophy: "Melambangkan kesederhanaan dan intuitif, merepresentasikan angkatan yang sederhana, mudah beradaptasi, dan memiliki pemikiran yang intuitif."
    },
    { 
      name: "Black Blue", 
      color: "#0e0d1b", 
  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      {/* Title */}
      <h3 className="text-4xl font-nexa font-bold text-white text-center mb-12 drop-shadow-lg">
        Color Palette
      </h3>
      ...
      <div className="relative">
        ...
        <div className="bg-gradient-to-r from-slate-800/60 to-slate-700/60 backdrop-blur-md rounded-full p-6 border border-white/20 shadow-2xl mb-8">
          <div className="flex justify-center items-center space-x-6">
            {colors.map((colorItem, index) => (
              ...
              >
                {/* Color Circle */}
                <div
                  className={`w-20 h-20 rounded-full border-3 relative overflow-hidden shadow-xl transition-all duration-300 ${
                    index === selectedColor 
        ...
        <div className="absolute -inset-4 bg-gradient-to-r from-blue-500/30 via-purple-500/30 to-cyan-500/30 rounded-full blur-2xl opacity-60 -z-10 animate-pulse"></div>
        <div className="absolute -inset-2 bg-gradient-to-r from-blue-400/20 via-purple-400/20 to-cyan-400/20 rounded-full blur-xl -z-10"></div>
      </div>
      ...
      {/* Additional Info */}
      <p className="text-center text-gray-300 text-base mt-8 max-w-lg mx-auto leading-relaxed drop-shadow-sm">
        Klik pada setiap warna untuk melihat filosofi dan makna dibalik setiap pilihan warna ETERION.
      </p>
    </div>
  );
}
