  ...
  return (
    ...
    >
      <div
        onClick={onClick}
        className={
          "relative flex h-2 w-2 md:h-6 md:w-6 cursor-pointer items-center justify-center transition-transform duration-300 group-hover:scale-110 filter drop-shadow-xl/50 drop-shadow-black" +
          (isActive ? " scale-110" : "")
        }
      >
        {/* Outer Ring */}
        ...
        {/* Inner Circle */}
        <div className="absolute top-1/2 left-1/2  h-1 w-1 md:h-3 md:w-3 -translate-x-1/2 -translate-y-1/2 rounded-full bg-white"></div>
      </div>
